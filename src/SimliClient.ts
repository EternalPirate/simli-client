...
class SimliClient {
    ...
    private _inputStreamTrack: MediaStreamTrack | null = null;
    private sourceNode: MediaStreamAudioSourceNode | null = null;
    private audioWorklet: AudioWorkletNode | null = null;
    private _audioBuffer: Int16Array | null = null;
...
export { SimliClient };
export type { SimliClientConfig, SimliClientEvents };
